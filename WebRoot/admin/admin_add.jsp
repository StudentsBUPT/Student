                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op left-menu_account">
                            ...
                            <a class="h5 text-white" href="index.html">
                                <span class="h4 font-w600 sidebar-mini-hide"><c:if test="${user!=null }">${user.name}</c:if></span>
                            </a>
                        </div>
                    </div>
                    <!-- Sidebar Content -->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-narrow">
                                    ...
                                    <form class="form-horizontal push-12-t" action="${pageContext.request.contextPath}/AddUser" method="post" >
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-text2" name="username">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-name" name="name">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    ...
                                                    <label for="material-phone">Phone</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="email" id="material-email2" name="email">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-color-info2" name="work">
                                                    <label for="material-color-info2">WorkAddress</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">

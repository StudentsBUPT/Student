            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/photo12@2x.jpg');">
                    <div class="push-50-t push-15">
                        ...
                        <h2 class="h5 text-white-op animated zoomIn">Welcome 管理员</h2>
                    </div>
                </div>
                <!-- END Page Header -->
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">人员总览表 <small>All</small></h3>
                        </div>
   ...
   <c:otherwise>
         学生  
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Client" onclick="edit('${item.username}','${item.name}')"><i class="fa fa-pencil"></i></button>
                                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove Client" onclick="del('${item.username}','${item.name}')"><i class="fa fa-times"></i></button>
                                            </div>
                                        </td>
                                    </tr> 
								</c:forEach>  
                                                ...
                                                <table class="table remove-margin-b font-s13">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right" style="width: 70px;">${user.username }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">姓名：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${user.name }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">类别：</td>
   ...
   <c:otherwise>
         学生  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right">${user.email }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">联系方式：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${user.phone }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">工作地点：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${user.work }</td>
                                                        </tr>
    ...
    <form action="http://www.baidu.com" method="post">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="work" placeholder="工作地点">
                </div>
            </div>

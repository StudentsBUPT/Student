                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content left-menu-wrap">
                            <ul class="nav-main">
                                <li>
                                    <a class="active" href="index.html"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">首页</span></a>
                                </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="addmanage.jsp"><i class="si si-grid"></i><span class="sidebar-mini-hide">课程管理</span></a>
                        ...
                        <div class="side-header side-content bg-white-op left-menu_account">
                            ...
                            <a class="h5 text-white" href="index.html">
                                <span class="h4 font-w600 sidebar-mini-hide"><c:if test="${user!=null }">${user.name}
								</c:if>
								</span>
                            </a>
                        </div>
            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/photo12@2x.jpg');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn">添加教师</h1>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-narrow">
                                    ...
                                    <form class="form-horizontal push-12-t" action="${pageContext.request.contextPath}/AddTeacher" method="post" >
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-text2" name="teacherid">
                                                    <label for="material-text2">教师编号</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="password" id="material-password2" name="password">
                                                    <label for="material-password2">密码</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-name" name="teachername">
                                                    <label for="material-name">教师姓名</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="dist">
                                                    <label for="material-phone">教师所属学院</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="gender">
                                                    <label for="material-phone">性别</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="phone">
                                                    <label for="material-phone">联系方式</label>
                                                </div>
                                            </div>
                                        </div>

            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/photo12@2x.jpg');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn">学生管理</h1>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">教师预览表 <small>All</small></h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs" style="width: 15%;">性别</th>
...
<!--                                     
                                   <tr>
                                        ...
                                        <td class="font-w600">14110506015</td>
                                        <td class="font-w600">lzx</td>
                                        <td class="font-w600">计算机学院</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600">14110506014</td>
                                        <td class="font-w600">lxl</td>
                                        <td class="font-w600">计算机学院</td>
                                        <td class="hidden-xs">2014</td>
                                        <td class="hidden-xs">
                                            <span class="label label-success">男</span>
